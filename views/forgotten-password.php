...
<body class = "root-setting">
    ...
    <main class = "d-md-flex flex-md-row">
        ...
        <section class = "custom-section rounded d-table py-3 px-3 px-sm-4 px-xl-5">
            <div>
                <h2 class="h4 text-center title-lead text-light mb-4">Password recovery</h2>
                <p class = "text-light p-lead text-center mt-1">Please enter your email address and we will send you a link to reset your password</p>
            </div>

            <form action = "" method="post">
                <div class=" mt-4 mb-3 mt-xl-5 position-relative">
                ...
                <div class="mb-3 mt-xl-2">
                    <button id = "btn-submit" class="btn bg-gray text-light fs-btn w-100 mt-3 mt-md-5 overflow-hidden position-relative" type="button">Send email</button>
                </div>
            </form>
        </section>
    </main>
